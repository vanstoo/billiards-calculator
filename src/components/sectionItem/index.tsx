  ...
  return (
    <View className="at-row">
      ...
      <View className="at-col at-col-9 at-col--wrap">
        ...
        <Text className={isLinkCol ? 'link-col section-content' : 'section-content'} onClick={() => contentClick()}>
          {content ? content : '-'}
        </Text>
        {copyable && content && (
          <Text onClick={() => Taro.setClipboardData({ data: content.toString() })} className="link-col margin-left-16">
            复制
          </Text>
        )}
